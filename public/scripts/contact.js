...
// Copy Social Media At
const socialMediaAt = document.querySelector(".social-media-at");
const copyTooltip = document.querySelector(".card-at .tooltip");
let copyAtLock = false;
socialMediaAt.addEventListener("click", () => {
    if (copyAtLock) return false;
    copyAtLock = true;

    navigator.clipboard.writeText("@swordax.sy").then(() => {
        copyAtLock = false;
